...
class RaibaPanel extends HTMLElement {
  ...
  _styles() {
    return `
      :host { display: block; height: 100%; font-family: var(--paper-font-body1_-_font-family, Roboto, sans-serif); --primary: var(--primary-color, #03a9f4); --sidebar-width: 280px; }
      ...
      *, *::before, *::after { box-sizing: border-box; }
      ...
      .badge { background: var(--primary); color: #fff; border-radius: 10px; padding: 1px 7px; font-size: 11px; font-weight: 600; }
      ...
      .tx-item.unread .tx-icon ha-icon { color: var(--primary); }
      ...
      .btn-back { display: flex; align-items: center; gap: 6px; background: none; border: none; color: var(--primary); cursor: pointer; font-size: 14px; padding: 8px 12px; border-radius: 6px; }
      .btn-back:hover { background: color-mix(in srgb, var(--primary) 8%, transparent); }
      ...
      .detail-account-icon.unread-icon { color: var(--primary); }
      ...
      .sync-progress-bar { height: 100%; background: var(--primary); border-radius: 2px; transition: width 0.3s; width: 0%; }
